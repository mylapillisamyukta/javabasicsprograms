...
public class employeeassessment {
	...
	public static void main(String[] args) {
		employeeassessment tempemployee = new  employeeassessment("SHYAMALA", 50000, LocalDate.parse("2022-04-01"));
		employeeassessment peremployee = new  employeeassessment("SAMYUKTA", 70000, LocalDate.parse("2017-04-01"));
